...
<body class="bg-slate-100 min-h-screen p-6">
    <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow border border-slate-200 p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.trainings.store')); ?>" class="space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="<?php echo e(route('admin.trainings.index')); ?>" class="px-6 py-3 rounded-2xl bg-slate-200 text-slate-700 font-semibold hover:bg-slate-300 transition">
                    Kembali
                </a>
            </div>
        </form>
...
</html><?php /**PATH C:\laragon\www\diklat-balimed\resources\views/admin/trainings/create.blade.php ENDPATH**/ ?>